...
@section('content')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 card-hover">
                    <a href="{{ route('products') }}">
                        <img src="{{ asset('images/products/mango.jpg') }}" alt="Mangga" class="w-full h-56 object-contain">
                    </a>
                    <div class="p-5">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 card-hover">
                    <a href="{{ route('products') }}">
                        <img src="{{ asset('images/products/strawberry.jpg') }}" alt="strawberry" class="w-full h-56 object-contain">
                    </a>
                    <div class="p-5">
                        <h3 class="text-lg font-semibold mb-2">
                            <a href="{{ route('products') }}" class="text-gray-800 hover:text-orange-500 transition-colors duration-300">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 card-hover">
                    <a href="{{ route('products') }}">
                        <img src="{{ asset('images/products/naga-merah.jpg') }}" alt="Naga Merah" class="w-full h-56 object-contain">
                    </a>
                    <div class="p-5">
                        <h3 class="text-lg font-semibold mb-2">
                            <a href="{{ route('products') }}" class="text-gray-800 hover:text-orange-500 transition-colors duration-300">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 card-hover">
                    <a href="{{ route('products') }}">
                        <img src="{{ asset('images/products/green-smoothie.jpg') }}" alt="Green Smoothie" class="w-full h-56 object-contain">
                    </a>
                    <div class="p-5">
                        <h3 class="text-lg font-semibold mb-2">
                            <a href="{{ route('products') }}" class="text-gray-800 hover:text-orange-500 transition-colors duration-300">
    ...
    <div id="about" class="py-16 bg-gradient-to-r from-red-50 to-yellow-50">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-8 md:mb-0">
                    <img src="{{ asset('images/logo.png') }}" alt="About Juice Junkie" class="rounded-lg transform transition-transform duration-500 hover:rotate-2">
                </div>
    ...
    <div class="py-12 bg-gradient-to-r from-red-50 to-yellow-50">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="md:w-1/2">
                    <img src="{{ asset('images/products/lemon.jpg') }}" alt="Lemon Juice" class="w-full h-full object-cover transform transition-transform duration-500 hover:scale-105">
                </div>
            </div>
        </div>
    </div>
